// Include YepNope to load scripts in order.
...
// tell script.js that we're running in the context of another site
...
yepnope({
	...
	complete: function () {
		// Replace all images
		$('img').attr({
			'src': 'http://emuspin.com/img/emu.jpg',
			'class': 'emu'
		});

        soundManager.url = 'http://emuspin.com/swf/xdomain/';
        ...
        soundManager.onload = function() {
            ...
            soundManager
                .createSound({
                    id: 'Jake-Becker',
                    url:'http://emuspin.com/mp3/RightRound.mp3'
                })
                .play({
                    onfinish: function() {
                        this.play();
		...
		// Start spinning and music
		yepnope('http://emuspin.com/js/script.js');
	}
});
